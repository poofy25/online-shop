 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zh=new Map;function $h(e,t){const n=Fo(e);jh(n,t),q0(n,t)}function jh(e,t){const n=zh.get(e);if(n)for(const r of n)r(t)}function q0(e,t){const n=Y0();n&&n.postMessage({key:e,fid:t}),J0()}let qt=null;function Y0(){return!qt&&"BroadcastChannel"in self&&(qt=new BroadcastChannel("[Firebase] FID Change"),qt.onmessage=e=>{jh(e.data.key,e.data.fid)}),qt}function J0(){zh.size===0&&qt&&(qt.close(),qt=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var On=function(){return On=Object.assign||function(t){for(var n,r=1,i=arguments.length;r<i;r++){n=arguments[r];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(t[o]=n[o])}return t},On.apply(this,arguments)},Rp=function(e){return{loading:e==null,value:e}},Z1=function(){return function(e,t){switch(t.type){case"error":return On(On({},e),{error:t.error,loading:!1,value:void 0});case"reset":return Rp(t.defaultValue);case"value":return On(On({},e),{error:void 0,loading:!1,value:t.value});default:return e}}},eS=function(e){var t=e?e():void 0,n=k.useReducer(Z1(),Rp(t)),r=n[0],i=n[1],o=k.useCallback(function(){var l=e?e():void 0;i({type:"reset",defaultValue:l})},[e]),s=k.useCallback(function(l){i({type:"error",error:l})},[]),a=k.useCallback(function(l){i({type:"value",value:l})},[]);return k.useMemo(function(){return{error:r.error,loading:r.loading,reset:o,setError:s,setValue:a,value:r.value}},[r.error,r.loading,o,s,a,r.value])},tS=function(e,t){var n=eS(function(){return e.currentUser}),r=n.error,i=n.loading,o=n.setError,s=n.setValue,a=n.value;return k.useEffect(function(){var l=M_(e,function(u){return J1(void 0,void 0,void 0,function(){var d;return X1(this,function(h){switch(h.label){case 0:if(!(t!=null&&t.onUserChanged))return[3,4];h.label=1;case 1:return h.trys.push([1,3,,4]),[4,t.onUserChanged(u)];case 2:return h.sent(),[3,4];case 3:return d=h.sent(),o(d),[3,4];case 4:return s(u),[2]}})})},o);return function(){l()}},[e]),[a,i,r]};const nS="/online-shop/assets/logedOutProfileIcon-d865a437.png",rS="/online-shop/assets/logedInProfileIcon-59f87b6b.png",iS="/online-shop/assets/companyLogo-a2d24ab5.png",oS="/online-shop/assets/cartIcon-440718d0.png";let As=!1;function sS(){let e=Kv();const[t]=tS(Cp);let n=nS;return t&&(n=rS),An("div",{className:"Navbar",children:[An("button",{className:"menuButton",onClick:()=>{As?(As=!1,document.querySelector(".menuContainer").classList.remove("open")):(As=!0,document.querySelector(".menuContainer").classList.add("open"))},children:[M("div",{className:"menuButtonRow1"}),M("div",{className:"menuButtonRow2"}),M("div",{className:"menuButtonRow3"})]}),M("div",{className:"menuContainer"}),M("div",{className:"companyLogo",children:M("button",{onClick:()=>{e("/")},children:M("img",{src:iS})})}),An("div",{className:"navBtns",children:[M("div",{className:"accountBtn",children:M("button",{onClick:()=>{t||e("/login"),t&&e("/account")},children:M("img",{src:n})})}),M("div",{className:"cartBtn",children:M("button",{onClick:()=>{e("/cart")},children:M("img",{src:oS})})})]})]})}function aS(){return M("footer",{className:"footer",children:"© 2023 dalVin"})}const lS=k.lazy(()=>Xr(()=>import("./homepage-cf8db192.js"),["assets/homepage-cf8db192.js","assets/filter-8d223ecb.js","assets/homepage-99cc71cb.css"])),uS=k.lazy(()=>Xr(()=>import("./loginpage-b9fb9b3d.js"),["assets/loginpage-b9fb9b3d.js","assets/loginpage-694f2afc.css"])),cS=k.lazy(()=>Xr(()=>import("./accountpage-a136a35e.js"),["assets/accountpage-a136a35e.js","assets/accountpage-a6302aac.css"])),dS=k.lazy(()=>Xr(()=>import("./cartpage-8830588c.js"),["assets/cartpage-8830588c.js","assets/cartpage-f3d8ba13.css"])),fS=k.lazy(()=>Xr(()=>import("./ProductScreen-41e71a88.js"),["assets/ProductScreen-41e71a88.js","assets/filter-8d223ecb.js","assets/ProductScreen-b4de0e2b.css"]));function hS(){return An(em,{children:[M(sS,{}),An(ry,{children:[M(vn,{path:"/",element:M(gn.Suspense,{fallback:"Loading...",children:M(lS,{})})}),M(vn,{path:"/login",element:An(gn.Suspense,{fallback:"Loading...",children:[M(uS,{})," "]})}),M(vn,{path:"/account",element:M(gn.Suspense,{fallback:"Loading...",children:M(cS,{})})}),M(vn,{path:"/cart",element:M(gn.Suspense,{fallback:"Loading...",children:M(dS,{})})}),M(vn,{path:"/product/:id",element:M(gn.Suspense,{fallback:"Loading...",children:M(fS,{})})})]}),M(aS,{})]})}Ds.createRoot(document.getElementById("root")).render(M(iy,{children:M(hS,{})}));export{em as F,An as a,Cp as b,tS as c,pS as d,M as j,gS as p,k as r,mS as s,Kv as u};
